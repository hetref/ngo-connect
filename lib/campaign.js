...
import { collection, getDocs, addDoc, doc, getDoc, Timestamp, updateDoc } from 'firebase/firestore';
...
export async function updateCampaignRaisedAmount(campaignId, newAmount) {
